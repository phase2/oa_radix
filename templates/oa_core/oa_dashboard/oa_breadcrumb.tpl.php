    ...
    <?php if (!empty($space_label)): ?>
      <li class="btn-group oa-breadcrumb">
        <a href="<?php print $home_url; ?>"
           class="btn btn-home <?php print $oa_toolbar_btn_class; ?>"><i
            class="icon-home"></i><span
            class='element-invisible'>Home</span></a>
        <?php if (!empty($home_spaces)): ?>
          <a class="dropdown-toggle btn <?php print $oa_toolbar_btn_class; ?>"
             id="parent-dropdown" data-toggle="dropdown" href="#"><b
              class="caret"></b></a>
        ...
        <?php if (empty($sibling_list) && empty($parent_list)): ?>
          <li class="btn-group oa-breadcrumb">
            <a href="<?php print $parent_url; ?>"
               class="btn <?php print $oa_toolbar_btn_class; ?>"><?php print $parent_label; ?></a>
          </li>
        <?php else: ?>
          <li class="btn-group oa-breadcrumb dropdown">
            <a href="<?php print $parent_url; ?>"
               class="btn <?php print $oa_toolbar_btn_class; ?>"><?php print $parent_label; ?></a>
            <a class="dropdown-toggle btn <?php print $oa_toolbar_btn_class; ?>"
               id="sibling-dropdown" data-toggle="dropdown" href="#"><b
                class="caret"></b></a>
            <ul class="dropdown-menu" role="menu"
                aria-labelledby="sibling-dropdown">
      ...
      <?php endif; ?>
      <li class="btn-group oa-breadcrumb">
        <a href="<?php print $space_url; ?>"
           class="btn <?php print $oa_toolbar_btn_class; ?>"><?php print $space_label; ?></a>
        <?php if (!empty($subspaces) || !empty($sections_list)): ?>
          <a class="dropdown-toggle btn <?php print $oa_toolbar_btn_class; ?>"
             id="subspace-dropdown" data-toggle="dropdown" href="#"><b
              class="caret"></b></a>
          <ul class="dropdown-menu" role="menu"
              aria-labelledby="subspace-dropdown">
      ...
      <?php if (!empty($section_label)): ?>
        <li class="btn-group oa-breadcrumb">
          <?php if (!empty($section_label)): ?>
            <a href="<?php print $section_url; ?>"
               class="btn <?php print $oa_toolbar_btn_class; ?>"><?php print $section_label; ?></a>
          <?php endif; ?>
        </li>
      <?php endif; ?>
    <?php endif; ?>

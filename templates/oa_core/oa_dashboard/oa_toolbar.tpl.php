...
<ul id="oa_toolbar" class="oa_toolbar">
  <?php if (!empty($space_label)): ?>
    <li class="btn-group">
      <a href="<?php print $home_url; ?>"><i class="icon-home"></i><span
    ...
    <li class="dropdown btn-group">
      ...
      <a class="dropdown-toggle btn <?php print $oa_toolbar_btn_class; ?>"
         id="space-dropdown" data-toggle="dropdown" href="#"><b
          class="caret"></b></a>
    ...
    <?php if (!empty($section_label)): ?>
      <li class="dropdown btn-group">
        ...
        <a class="dropdown-toggle btn <?php print $oa_toolbar_btn_class; ?>"
           id="section-dropdown" data-toggle="dropdown" href="#"><b
            class="caret"></b></a>
        <ul class="dropdown-menu" role="menu"
            aria-labelledby="section-dropdown">

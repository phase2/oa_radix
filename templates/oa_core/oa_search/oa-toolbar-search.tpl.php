...
<div class="toolbar-search">
  <form action="search/site" method="post">
    <div class="input-append">
      ...
      <div class="btn-group">
        <button type="submit"
                class="btn submit <?php print $oa_toolbar_btn_class; ?>">
          <i class="icon-search"></i><span
            class="element-invisible"><?php print t('Search Button'); ?></span>
        </button>
        <button
          class="btn dropdown-toggle <?php print $oa_toolbar_btn_class; ?>"
          data-toggle="dropdown">
          <i class="caret"></i><span
            class="element-invisible"><?php print t('Search Options'); ?></span>
        </button>
